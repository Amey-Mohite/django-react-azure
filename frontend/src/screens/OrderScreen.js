...
function OrderScreen() {
    ...
    console.log("prdefsd",orderId['id'])
    ...
    const addPaypalScript = () =>{
        ...
        script.src = "https://www.paypal.com/sdk/js?client-id=ASfOcKoh637wIfmQmpn9J__IdOaLTri6nhEyweSLhbzPWlhYb6ExJufmdTB4munMgzFpB-mX41igjiVu"
        script.async = true
        script.onload = ()=>{
            setSdkReady(true)
        }
            ...
            <ListGroup variant = 'flush'>
                <ListGroup.Item>
                    ...
                    {order.isDelivered ? (
                        ...
                        <Message variant = 'warning'>Not Devlivered</Message>
                    )}
                </ListGroup.Item>
                <ListGroup.Item>
